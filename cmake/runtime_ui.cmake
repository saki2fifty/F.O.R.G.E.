...
if(BUILD_TESTING)
 ...
 add_executable(forge_ui_catalog_presenter_tests tests/ui_presenter_tests.cpp)
 target_compile_definitions(forge_ui_catalog_presenter_tests PRIVATE FORGE_UI_CATALOG_TEST=1)
 target_include_directories(forge_ui_catalog_presenter_tests PRIVATE src)
 target_link_libraries(forge_ui_catalog_presenter_tests PRIVATE forge_ui_presenter forge_ui_asset_catalog RmlUi::Core)
 add_test(NAME ui_catalog_presenter COMMAND forge_ui_catalog_presenter_tests ${CMAKE_BINARY_DIR}/ui-catalog-presenter-data "${PROJECT_SOURCE_DIR}/resources/ui/LatoLatin-Regular.ttf")
endif()

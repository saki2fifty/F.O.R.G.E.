...
Local headless tests pass for altitude input and release behavior, reversed pan, telemetry arithmetic, and bottom-bar layout/docking separation at 65%, 100%, and 200% scale in 640- and 1440-pixel windows. Windows build, native process-counter validation, and desktop checks remain pending for this batch.

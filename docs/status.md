...
Fix verified in Build **260916-000013**, source `bef18c9041199bb9f5835070343d67924c544081`, [Windows run35065027543](https://github.com/saki2fifty/F.O.R.G.E./actions/runs/35065027543). All jobs passed, including the Windows open-reader reproduction and migration/fallback/retry tests. Downloaded package identity, manifest hashes, ZIP CRC and matching manual were verified. Desktop launch/restart confirmation remains pending.

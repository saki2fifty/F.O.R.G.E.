...
| Topology/indices | Point, line and triangle lists; loops/strips/fans normalize to matching list geometry; indexed8/16/32-bit source and nonindexed input | Fixed raster point/line width; forbidden restart values and out-of-range indices reject; gltf_mesh_processing, mesh_asset |
...
| [KHR_gaussian_splatting](https://github.com/KhronosGroup/glTF/blob/836573be93954f26827e3dc16476f8620209a1f2/extensions/2.0/Khronos/KHR_gaussian_splatting/README.md) | NOT APPLICABLE TO CURRENT FORGE DOMAIN | Separate point/splat geometry, covariance projection, spherical-harmonic radiance and camera-distance sorting are outside this conventional MeshRenderer phase. No fake triangle interpretation or point fallback. | Required extension rejects; ordinary point primitives do not implement Gaussian splats |

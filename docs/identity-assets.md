...
The Content panel browses registered assets and discovers saved scenes; see the user manual for its implemented workflows and scan limits. The shared import/cook pipeline and typed runtime ResourceLease consumers use these identities; see [asset services](asset-foundation.md). No additional persistent DocumentId or runtime SceneInstanceId is introduced.
